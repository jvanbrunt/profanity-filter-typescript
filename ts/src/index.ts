...
export class ProfanityResult {

    profanities: string[]

    constructor(profanitites: string[]) {
        this.profanities = profanitites
    }

    get containsProfanities(): boolean {
        return this.profanities.length > 0
    }
}

export let defaultBlackList: string[] = [
    "2 girls 1 cup",
        "2 girls one cup",
        "2g1c",
        "4r5e",
